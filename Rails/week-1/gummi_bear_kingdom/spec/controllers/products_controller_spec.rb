...
RSpec.describe ProductsController, type: :controller do
  ...
  let(:valid_attributes) {
    { :name => 'Cupcake', :cost => 40, :origin => 'Cupcake Palace' }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { :name => 'BETTER CUPCAKE', :cost => 100, :origin => 'Gummy Research Lab'}
      }
      ...
      it "updates the requested product" do
        ...
        product.reload
        expect(product.name).to eq 'BETTER CUPCAKE'
        expect(product.cost).to eq 100
        expect(product.origin).to eq 'Gummy Research Lab'
      end
